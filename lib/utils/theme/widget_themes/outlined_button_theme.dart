...
class TOutlinedButtonTheme {
  ...
  static final lightOutlinedButtonTheme  = OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      padding:  const EdgeInsets.symmetric(vertical: TSizes.buttonHeight18, horizontal: 20),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(TSizes.buttonRadius10)),
