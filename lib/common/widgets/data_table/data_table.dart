    ...
    return SizedBox(
      ...
      child: DataTable2(
        ...
        decoration: const BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.all(Radius.circular(TSizes.borderRadiusMd8)),
        ),
        // Set the decoration for the heading row of the data table
        headingRowDecoration: const BoxDecoration(
          borderRadius: BorderRadius.only(topLeft: Radius.circular(TSizes.borderRadiusMd8), topRight: Radius.circular(TSizes.borderRadiusMd8)),
        ),
      ),
    );
  }
